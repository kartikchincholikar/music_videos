...
class AudioIPAdapterTransitions(AudioNodeBase):
	...
	def process_transitions(self, images, peaks_weights, transition_mode, transition_length, min_IPA_weight, max_IPA_weight):
		...
		print("Identify frames where index changes")
		print(change_frames)
		...
		try:
			...
			plt.scatter(range(0, len(blending_weights_array)), blending_weights_array, label='Blending Weights', color='green', alpha=0.7)
